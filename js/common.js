...
F._createOrder_td = F._IP_191 + ":" + F._port_83 + "/fun/trade/createOrder"; // 创建（分期）订单
F._batchCreateOrder_td = F._IP_191 + ":" + F._port_83 + "/fun/trade/batchCreateOrder"; // 批量订单-创建
F._batchPayment_td = F._IP_191 + ":" + F._port_83 + "/fun/trade/batchPayment"; // 批量订单-支付
